...
class AreanetPromotionValidator implements EventSubscriberInterface {
    /**
    ...
    public function preValidate(PreWriteValidationEvent $event): void
    {
        ...
        /** <===== THE ONE AND ONLY AREANET CODE */
        foreach($violationList as $i=>$violation) {

            if($violation->getCode() == 'PROMOTION_DISCOUNT_MIN_VALUE_VIOLATION'){
